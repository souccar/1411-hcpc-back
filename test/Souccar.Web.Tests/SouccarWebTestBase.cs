...
{
    public abstract class SouccarWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SouccarWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SouccarWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SouccarDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SouccarDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SouccarDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SouccarDbContext, Task<T>> func)
        {
            T result;
