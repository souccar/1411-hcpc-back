...
{
    public interface IWarehouseMaterialAppService : 
        IAsyncSouccarAppService<WarehouseMaterialDto, int, FullPagedRequestDto, CreateWarehouseMaterialDto, UpdateWarehouseMaterialDto>
    {
